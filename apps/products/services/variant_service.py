...
class ProductVariantService:
    ...
    def create_variants_async(
        ...
        from apps.products.tasks.variant import create_product_variants_task
    ...
    def update_variant_cache_async(product_id: int, delay_seconds: int = 5):
        ...
        from apps.products.tasks.variant import update_product_variant_cache_task
    ...
    def generate_combinations_async(
        ...
        from apps.products.tasks.variant import generate_variant_combinations_task
    ...
    def generate_and_create_variants_async(
        ...
        from apps.products.tasks.variant import generate_and_create_variants_task
    ...
    def bulk_stock_update_async(stock_updates: List[Dict], delay_seconds: int = 0):
        ...
        from apps.products.tasks.variant import bulk_stock_update_task
    ...
    def validate_product_variants_async(product_id: int, delay_seconds: int = 0):
        ...
        from apps.products.tasks.variant import validate_product_variants_task
