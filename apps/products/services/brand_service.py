...
from apps.products.tasks.brand import bulk_generate_variants_for_template
from apps.notifications.services.notification_service import NotificationService
from apps.products.tasks.brand import (
    update_brand_stats,
)
from apps.core.utils.cache_manager import CacheManager
from apps.core.utils.cache_key_manager import CacheKeyManager
from apps.products.utils.brand_variants import (
...
class BrandService:
    ...
    def bulk_create_brands(brands_data: List[Dict]) -> List[Brand]:
        ...
        from apps.products.tasks.brand import bulk_generate_variants_for_brands
...
class BrandVariantService:
    ...
    def get_variant_for_locale(
        ...
        from apps.products.tasks.brand import auto_generate_brand_variants
