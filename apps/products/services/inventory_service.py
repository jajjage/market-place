...
class InventoryService:
    ...
    def release_from_escrow(
        ...
        **kwargs,
        ...
        Args:
            variant: The variant to release from escrow
        ...
        """
        # Allow both variant and product keywords, or extract from escrow transaction
        target_variant = variant or kwargs.get("product") or (escrow_transaction.variant if escrow_transaction else None)
        if not target_variant:
            raise ValueError("A product variant must be provided to release from escrow.")
