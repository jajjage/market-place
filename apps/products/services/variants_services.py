...
from apps.products.models import (
    ...
    ProductVariant,
    Product,  # used in cache‐update logic
)
...
class ProductVariantService:
    ...
    def create_variants_async(
        ...
        """
        from apps.products.tasks.variant_tasks import create_product_variants_task
    ...
    def update_variant_cache_async(product_id: int, delay_seconds: int = 5):
        ...
        """
        from apps.products.tasks.variant_tasks import update_product_variant_cache_task
    ...
    def generate_combinations_async(
        ...
        """
        from apps.products.tasks.variant_tasks import generate_variant_combinations_task
    ...
    def bulk_create_variants_async(self, variant_payload: Dict):
        ...
        """
        from apps.products.tasks.variant_tasks import bulk_create_product_variants_task
