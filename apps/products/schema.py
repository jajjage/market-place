from drf_spectacular.utils import OpenApiResponse, extend_schema, OpenApiExample, OpenApiParameter, OpenApiTypes
from apps.products.serializers.base import ProductDetailSerializer, ManageMetadataSerializer
