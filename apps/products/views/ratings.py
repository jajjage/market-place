# apps/products/views/product_rating_viewset.py
...
from apps.products.models.product_ratings import ProductRating
from apps.products.serializers import ProductRatingsSerializer
from apps.products.serializers.ratings import (
