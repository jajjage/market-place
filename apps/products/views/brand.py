...
from apps.products.models import Brand, BrandRequest, BrandVariant, BrandVariantTemplate
...
from apps.products.utils.filters import BrandFilter
...
class BrandViewSet(BaseViewSet):
    ...
    def refresh_stats(self, request, pk=None):
        ...
        brand = self.get_object()
        from apps.products.tasks import update_brand_stats
